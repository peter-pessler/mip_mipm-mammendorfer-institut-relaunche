;(function ($) {
    ...
    $.fn.fileinput = function (o) {
        ...
        o = $.extend({
            ...
            clearButton: '<div class="fileinput-clear close"></div>',
            complete: function () {}
        }, o || {});
        ...
        this.each(function (i, elem) {
            ...
            // PP $input.closest('.fileinput').prepend($('<span></span>').html(title));
            ...
            $(document).on('change', '.fileinput input[type=file]', function () {
                ...
                $wrapper.addClass(options.selectedClass)
                    // PP .append('<span class="fileinput-name">' + fileName + options.clearButton + '</span>');
                    .append('<span class="fileinput-name">' + '<span class="fileresult">' + fileName + '</span>'  + options.clearButton  + '</span>');
            });
